...
func (c *AndEvaluator) Evaluate(traceID pcommon.TraceID, trace *TraceData) (Decision, error) {
...
func (c *AndEvaluator) OnDroppedSpans(pcommon.TraceID, *TraceData) (Decision, error) {
	return Sampled, nil
}
