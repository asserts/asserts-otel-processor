...
package tailsamplingprocessor // import github.com/asserts/asserts-otel-processor/samplingprocessor
...
var _ PolicyEvaluator = (*CompositeEvaluator)(nil)
...
func (c *CompositeEvaluator) Evaluate(traceID pcommon.TraceID, trace *TraceData) (Decision, error) {
...
func (c *CompositeEvaluator) OnDroppedSpans(pcommon.TraceID, *TraceData) (Decision, error) {
	// Here we have a number of possible solutions:
	// 1. Random sample traces based on maxTotalSPS.
	// 2. Perform full composite sampling logic by calling CompositeEvaluator.Evaluate(), essentially
